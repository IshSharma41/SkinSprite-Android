    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_1mg_url));
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_PharmEasy_url));
            }
        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_Netmeds_url));
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_Medlife_url));
            }
        });
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_Practo_url));
            }
        });
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_Amazon_Pharmacy_url));
            }
        });
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_MedPlus_Mart_url));
            }
        });
        ...
        button8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_CVS_Pharmacy_url));
            }
        });
        ...
        button9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebPage(getString(R.string.Option_Apollo_To_Name_A_Few_url));
            }
        });
    }
